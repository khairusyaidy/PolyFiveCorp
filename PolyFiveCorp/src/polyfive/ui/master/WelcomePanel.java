...
public class WelcomePanel extends MasterPanel  {
	...
	public WelcomePanel() {
		...
		btnNewButton.setBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(64, 64, 64), null));
		...
		btnNewButton_2.setBorder(new EtchedBorder(EtchedBorder.LOWERED, Color.DARK_GRAY, null));
		btnNewButton_2.setBackground(new Color(255, 165, 0));
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setBounds(444, 40, 500, 500);
		lblNewLabel.setAutoscrolls(true);
		lblNewLabel.setIcon(new ImageIcon(WelcomePanel.class.getResource("/polyFive/ui/images/p5cicon.png")));
		add(lblNewLabel);
		...
		button.setIcon(new ImageIcon(WelcomePanel.class.getResource("/polyFive/ui/images/p5cicon7575.png")));
