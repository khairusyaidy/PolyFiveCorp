...
public class EventDetails extends MasterPanel {
	...
	public EventDetails() {
		...
		txtDisneyLiveMickeys.setText("Disney Live! Mickey's Rockin' Road Show\r\n27 November - 2 December 2012, Marina Bay Sands\r\n(Seating)");
		...
		lblNewLabel.setIcon(new ImageIcon(EventDetails.class.getResource("/polyFive/ui/images/Map.PNG")));
		...
		txtHitTheRoad.setText("Hit the road with Mickey Mouse and your favorite Disney friends!");
		...
		button_1.setIcon(new ImageIcon(EventDetails.class.getResource("/polyFive/ui/images/p5cicon7575.png")));
