...
public class MemberCalendar extends MasterPanel {
	...
	public MemberCalendar() {
		...
		btnLogOut.setBorder(new EtchedBorder(EtchedBorder.LOWERED, Color.DARK_GRAY, null));
		...
		button.setIcon(new ImageIcon(MemberCalendar.class.getResource("/polyFive/ui/images/p5cicon7575.png")));
