...
public class PaymentPanel extends MasterPanel {
	...
	public PaymentPanel() {
		...
		btnPayPal.setIcon(new ImageIcon(PaymentPanel.class.getResource("/polyFive/ui/images/paypallogo.jpg")));
		...
		btnCreditCard.setIcon(new ImageIcon(PaymentPanel.class.getResource("/polyFive/ui/images/rsz_credit-card-icon.jpg")));
		...
		btnNets.setIcon(new ImageIcon(PaymentPanel.class.getResource("/polyFive/ui/images/large-news_2755.jpg")));
		...
		button.setIcon(new ImageIcon(PaymentPanel.class.getResource("/polyFive/ui/images/p5cicon7575.png")));
		...
		JLabel lblPleaseChooseYour = new JLabel("Please choose your payment modes: ");
