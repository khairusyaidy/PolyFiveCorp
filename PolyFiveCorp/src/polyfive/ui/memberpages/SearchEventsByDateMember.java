...
public class SearchEventsByDateMember extends MasterPanel {
	...
	public SearchEventsByDateMember(MainFrame frame) {
		...
		button.setIcon(new ImageIcon(SearchEventsByDateMember.class
			...
			case 2:
				...
				button.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						EventDetailsMember eventDetailsPage = new EventDetailsMember(
								f);
						f.getContentPane().removeAll();
