...
public class AccountDetails extends MasterPanel {
	...
	public AccountDetails() {
		...
		LogOutButton.setBorder(new EtchedBorder(EtchedBorder.LOWERED, Color.DARK_GRAY, null));
		...
		changeDetails.setBorder(new EtchedBorder(EtchedBorder.LOWERED, Color.DARK_GRAY, null));
		...
		lockChanges.setBorder(new EtchedBorder(EtchedBorder.LOWERED, Color.DARK_GRAY, null));
		...
		btnTransactionHistory.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		btnTransactionHistory.setFocusPainted(false);
		btnTransactionHistory.setBorder(new EtchedBorder(EtchedBorder.LOWERED, Color.DARK_GRAY, null));
		...
		btnChangePassword.setBorder(new EtchedBorder(EtchedBorder.LOWERED, Color.DARK_GRAY, null));
		...
		btnCurrentBookings.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		btnCurrentBookings.setFocusPainted(false);
		btnCurrentBookings.setBorder(new EtchedBorder(EtchedBorder.LOWERED, Color.DARK_GRAY, null));
		...
		btnUpgradeAccount.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		btnUpgradeAccount.setFocusPainted(false);
		btnUpgradeAccount.setBorder(new EtchedBorder(EtchedBorder.LOWERED, Color.DARK_GRAY, null));
		...
		button_2.setBorder(new EtchedBorder(EtchedBorder.LOWERED, Color.DARK_GRAY, null));
		...
		button_3.setIcon(new ImageIcon(AccountDetails.class.getResource("/polyFive/ui/images/p5cicon7575.png")));
